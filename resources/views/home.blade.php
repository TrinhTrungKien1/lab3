...
<body>
    ...
    <div class="container">
        ...
        <br><br><br> --}}
        <div class="card">
            <h5 class="card-header bg-success">List Book</h5>
                        ...
                        @foreach ($list as $index => $bk)
                            <tr>
                                ...
                                <td><a href="{{ route('book.show', ['id' => $bk->id]) }}" class="btn btn-success">Chi
                                        tiết</a>
                                    <a href="{{ route('book.edit', $bk->id) }}" class="btn btn-primary">Chỉnh
                                        sửa
                                    </a>
                                    <form action="{{ route('book.destroy', $bk->id) }}" method="POSt">
                                        ...
                                        <button type="submit" class="btn btn-danger"
                                            onclick="return confirm('Bạn có muốn xoá k?')">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
